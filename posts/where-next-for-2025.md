---
title: Life Itself Research – Where Next for 2025
date: 2025-01-14
---
...
* Challenge in showcasing the group's work and impact, for example it is hard to see what the outputs are on [lifeitself.org/research](http://lifeitself.org/research)  
...
* Lack an overall, “agreed” research plan (though note [recent progress](https://docs.google.com/document/d/18a2GcdWv0-22nIdHQDTd_aQcU2T48nlqUWzC-ZQxFBo/edit?tab=t.0#heading=h.ngi0ppktbft8) thanks to Jonah and others …) or, rather, lacks a plausible and effective strategy for encouraging and supporting the development of particular pieces of research work, output and dissemination.

More specifically:

* Insufficient visibility of significant outputs[^1], members, and activities which means that people don’t use the outputs, don’t see that they could join and generally don’t see the group and how awesome it is …  
...
6. **\[V,P\] Annual Journal / Essay compendium(?)**: Maybe create a journal or some kind of annual or even twice yearly special output that contains essays that people have written on particular themes and have that particularly printed and promoted  
   * Jonah created separate doc: [Research Dissemination Ideas](https://docs.google.com/document/d/1D62Bl_B-R-tSs8Yz0cexA5xEaGNC4SHHnm3OMZ2wJWs/edit?usp=sharing)  \[and folks agree this seems good and recommendations there supersede any specific suggestion here\]  
7. **\[P\] Organizing Framework**: Create a research plan and perhaps specific SCQH (Situation-Complication-Question-Hypothesis) with structured set of questions to structure the inquiry we are engaging in … and use it to organize research efforts and track how individual outputs contribute to overarching questions (e.g. in any given session, talk or paper we could see what part of the inquiry it relates to) **Note we already have[Draft Second Renaissance Research Plan](https://docs.google.com/document/d/18a2GcdWv0-22nIdHQDTd_aQcU2T48nlqUWzC-ZQxFBo/edit?tab=t.0#heading=h.ngi0ppktbft8) \[Discussion below in appendix\]**
...
**Note we already have [Draft Second Renaissance Research Plan](https://docs.google.com/document/d/18a2GcdWv0-22nIdHQDTd_aQcU2T48nlqUWzC-ZQxFBo/edit?tab=t.0#heading=h.ngi0ppktbft8)**
...
| **Structure** | Informal[^2], flexible, collaborative. | Formal, structured, client-oriented. |
...
| **Membership** | Open[^3] to scholars, researchers, and sensemaking enthusiasts; emphasis on high-caliber participants but not exclusively professional. | Closed, professional team with defined roles and expertise. |
...
Comments from Martin in [https://github.com/orgs/life-itself/discussions/1149\#discussioncomment-11649804](https://github.com/orgs/life-itself/discussions/1149#discussioncomment-11649804) 
...
One of the frustrations[^4] in particular is the asynchronous communication which leads to a lot of loose ends.

1. Delayed responses  
2. Lack of feedback  
3. High volume of topics that lead to information overload  
4. Lack of conclusions / closure
...
[^1]:  For example, we have quite a few outputs in the the last few years. Just in the last year, we have 2R white papers (and more materials), we have the emergent power piece, we have the ecosystem mapping, we have various presentations (more brown-baggy but still outputs etc). We also have the work with Theo at Labs and by Liam before that many of which are not visible on the [lifeitself.org/research](http://lifeitself.org/research) website. We also have various threads / materials on forum that could be written up as small pieces. etc.

[^2]:  Inviting continued attention to the dimension of formality/informality in LIRe, which needs more work.

[^3]:  But as a commoning community we still need what some people call "membranes". Any group needs a minimal level of exclusivity to function effectively, e.g. effective moderation in a forum.

[^4]:  Frustrations differ from person to person, and worth addressing through dialogue in the hope to minimize them overall.
